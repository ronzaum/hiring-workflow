...
1. Read:
   ...
   - /workflow/roles/[CompanyName_RoleTitle]/04_HM_review.md
...
Save output to: /workflow/roles/[CompanyName_RoleTitle]/05_tailored_CV_final.md

6. Generate the PDF:
   Run the following command in the terminal:
   bash workflow/master/generate_cv.sh workflow/roles/[CompanyName_RoleTitle]/05_tailored_CV_final.md workflow/roles/[CompanyName_RoleTitle]/[CompanyName_RoleTitle]_CV.pdf
...
2. Update the CV Changes section of /workflow/roles/[CompanyName_RoleTitle]/00_application_master.md:
